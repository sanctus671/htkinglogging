...
/* harmony import */ var _services_authentication_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./services/authentication/auth-guard.service */ "./src/app/services/authentication/auth-guard.service.ts");
...
var routes = [
    {
        ...
        canActivate: [_services_authentication_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuardService"]]
    },
    ...
    {
        path: 'profiles/:id',
        loadChildren: function () { return Promise.all(/*! import() | pages-profile-profile-module */[__webpack_require__.e("default~documents-documents-module~forms-forms-module~pages-profile-profile-module~submissions-submi~bf117beb"), __webpack_require__.e("common"), __webpack_require__.e("pages-profile-profile-module")]).then(__webpack_require__.bind(null, /*! ./pages/profile/profile.module */ "./src/app/pages/profile/profile.module.ts")).then(function (m) { return m.ProfilePageModule; }); }
    },
    {
        path: 'settings',
        loadChildren: function () { return Promise.all(/*! import() | pages-settings-settings-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-settings-settings-module")]).then(__webpack_require__.bind(null, /*! ./pages/settings/settings.module */ "./src/app/pages/settings/settings.module.ts")).then(function (m) { return m.SettingsPageModule; }); }
    },
    {
        path: 'documents',
        loadChildren: function () { return Promise.all(/*! import() | pages-documents-documents-module */[__webpack_require__.e("default~documents-documents-module~forms-forms-module~pages-profile-profile-module~submissions-submi~bf117beb"), __webpack_require__.e("documents-documents-module")]).then(__webpack_require__.bind(null, /*! ./pages/documents/documents.module */ "./src/app/pages/documents/documents.module.ts")).then(function (m) { return m.DocumentsPageModule; }); }
    },
    {
        path: 'submissions',
        loadChildren: function () { return Promise.all(/*! import() | pages-submissions-submissions-module */[__webpack_require__.e("default~documents-documents-module~forms-forms-module~pages-profile-profile-module~submissions-submi~bf117beb"), __webpack_require__.e("common"), __webpack_require__.e("submissions-submissions-module")]).then(__webpack_require__.bind(null, /*! ./pages/submissions/submissions.module */ "./src/app/pages/submissions/submissions.module.ts")).then(function (m) { return m.SubmissionsPageModule; }); }
    },
    {
        path: 'form/:id',
        loadChildren: function () { return Promise.all(/*! import() | pages-form-form-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-form-form-module")]).then(__webpack_require__.bind(null, /*! ./pages/form/form.module */ "./src/app/pages/form/form.module.ts")).then(function (m) { return m.FormPageModule; }); }
    },
    {
        path: 'submission/:id',
        loadChildren: function () { return Promise.all(/*! import() | pages-submission-submission-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-submission-submission-module")]).then(__webpack_require__.bind(null, /*! ./pages/submission/submission.module */ "./src/app/pages/submission/submission.module.ts")).then(function (m) { return m.SubmissionPageModule; }); }
    }
];
    ...
    AppComponent.prototype.initializeApp = function () {
        ...
        this.platform.ready().then(function () {
            ...
            if (_this.platform.is("android")) {
                _this.statusBar.backgroundColorByHexString("#a51419");
            ...
            _this.authenticationService.retreiveUserData().then(function () { }).catch(function () { });
            _this.authenticationService.authState.subscribe(function (state) {
                if (state) {
            ...
            _this.uploadSubmissions();
        });
    };
    AppComponent.prototype.uploadSubmissions = function () {
        var _this = this;
...
/* harmony import */ var angular2_signaturepad__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! angular2-signaturepad */ "./node_modules/angular2-signaturepad/index.js");
/* harmony import */ var angular2_signaturepad__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(angular2_signaturepad__WEBPACK_IMPORTED_MODULE_13__);
...
var AuthenticationService = /** @class */ (function () {
    function AuthenticationService(http, storage, platform) {
        var _this = this;
        this.http = http;
        this.storage = storage;
        this.platform = platform;
        this.authState = new rxjs__WEBPACK_IMPORTED_MODULE_6__["BehaviorSubject"](false);
        this.userData = new rxjs__WEBPACK_IMPORTED_MODULE_6__["BehaviorSubject"](false);
        this.platform.ready().then(function () {
            _this.ifLoggedIn();
        });
    }
    AuthenticationService.prototype.ifLoggedIn = function () {
        var _this = this;
        this.storage.get('ht_token').then(function (response) {
            if (response) {
    ...
    AuthenticationService.prototype.login = function (data) {
        ...
        return new Promise(function (resolve, reject) {
            _this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl + "/auth/login", data).subscribe(function (res) {
                _this.storage.set("ht_token", res["token"]).then(function () {
                    _this.authState.next(true);
                });
                _this.retreiveUserData().then(function () { });
                resolve(res["token"]);
            }, function (e) {
                //console.log(e);
                reject(e);
    ...
    AuthenticationService.prototype.register = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl + "/auth/signup", data).subscribe(function (res) {
                _this.storage.set("ht_token", res["token"]).then(function () {
                    _this.authState.next(true);
                });
                _this.retreiveUserData().then(function () { });
    ...
    AuthenticationService.prototype.retreiveUserData = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.storage.get("ht_token").then(function (token) {
                if (token) {
                    _this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl + "/users/me?token=" + token).subscribe(function (res) {
                        _this.storage.set("sitters_user", res);
    ...
    AuthenticationService.prototype.resetPassword = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl + "/auth/recovery", data).subscribe(function (res) {
                resolve(res);
            }, function (e) {
                reject(e);
            });
    ...
    AuthenticationService.prototype.logout = function () {
        ...
        return new Promise(function (resolve, reject) {
            _this.storage.get("ht_token").then(function (token) {
                if (token) {
                    _this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl + "/auth/logout?token=" + token, {}).subscribe(function (res) {
                        resolve();
                    }, function (e) {
                        resolve();
                    });
    ...
    AuthenticationService.prototype.savePushId = function (id) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.storage.get("ht_token").then(function (token) {
                if (token) {
                    _this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl + "/updatepushid?token=" + token, { push_id: id }).subscribe(function (res) {
                        resolve();
                    }, function (e) {
                        reject(e);
                    });
    ...
    AuthenticationService.prototype.changePassword = function (email, password, passwordConfirm) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.storage.get("ht_token").then(function (token) {
                if (token) {
                    _this.http.put(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl + "/users/me?token=" + token, { email: email, password: password }).subscribe(function (res) {
                        resolve();
                    }, function (e) {
                        reject(e);
                    });
    ...
    AuthenticationService.prototype.getProfile = function (userId) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.storage.get("ht_token").then(function (token) {
                if (token) {
                    _this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl + '/profiles/' + userId + '?token=' + token).subscribe(function (res) {
                        resolve(res.profile);
                    }, function (e) {
                        reject(e);
                    });
    ...
    AuthenticationService.prototype.updateProfile = function (profile) {
        ...
        return new Promise(function (resolve, reject) {
            _this.storage.get("ht_token").then(function (token) {
                if (token) {
                    _this.http.put(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl + "/profiles/" + profile.id + "?token=" + token, profile).subscribe(function (res) {
                        resolve(res);
                    }, function (e) {
                        reject(e);
                    });
    ...
    AuthenticationService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"], _ionic_storage__WEBPACK_IMPORTED_MODULE_3__["Storage"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["Platform"]])
...
/***/ "./src/app/services/offline/offline.service.ts":
/*!*****************************************************!*\
  !*** ./src/app/services/offline/offline.service.ts ***!
  \*****************************************************/
...
var OfflineService = /** @class */ (function () {
    function OfflineService(http, storage) {
        this.http = http;
        this.storage = storage;
    }
    OfflineService.prototype.saveForms = function (forms) {
        this.storage.set("ht_forms", forms);
    };
    OfflineService.prototype.getForms = function () {
        return this.storage.get("ht_forms");
    };
    OfflineService.prototype.saveFormGroups = function (formGroups) {
        this.storage.set("ht_form_groups", formGroups);
    };
    OfflineService.prototype.getFormGroups = function () {
        return this.storage.get("ht_form_groups");
    };
    OfflineService.prototype.saveDocuments = function (documents) {
        this.storage.set("ht_documents", documents);
    };
    OfflineService.prototype.getDocuments = function () {
        return this.storage.get("ht_documents");
    };
    OfflineService.prototype.saveDocumentGroups = function (documentGroups) {
        this.storage.set("ht_document_groups", documentGroups);
    };
    OfflineService.prototype.getDocumentGroups = function () {
        return this.storage.get("ht_document_groups");
    };
    OfflineService.prototype.saveSubmission = function (submission) {
        var _this = this;
        this.storage.get("ht_submissions").then(function (submissions) {
            if (!submissions) {
                submissions = [];
            }
            submissions.push(submission);
            _this.storage.set("ht_submissions", submissions);
        });
    };
    OfflineService.prototype.saveSubmissions = function (submissions) {
        this.storage.set("ht_submissions", submissions);
    };
    OfflineService.prototype.getSubmissions = function () {
        return this.storage.get("ht_submissions");
    };
    OfflineService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] },
        { type: _ionic_storage__WEBPACK_IMPORTED_MODULE_3__["Storage"] }
    ]; };
    OfflineService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
            providedIn: 'root'
        }),
...
/***/ "./src/app/services/submission/submission.service.ts":
/*!***********************************************************!*\
  !*** ./src/app/services/submission/submission.service.ts ***!
  \***********************************************************/
...
var SubmissionService = /** @class */ (function () {
    function SubmissionService(http, storage) {
        this.http = http;
        this.storage = storage;
    }
    SubmissionService.prototype.getSubmissions = function (search) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.storage.get("ht_token").then(function (token) {
                if (token) {
                    _this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl + "/submissions?token=" + token + "&search=" + search).subscribe(function (res) {
                        resolve(res);
                    }, function (e) {
                        reject(e);
                    });
    ...
    SubmissionService.prototype.getSubmission = function (submissionId) {
        ...
        return new Promise(function (resolve, reject) {
            _this.storage.get("ht_token").then(function (token) {
                if (token) {
                    _this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl + "/submissions/" + submissionId + "?token=" + token).subscribe(function (res) {
                        resolve(res);
                    }, function (e) {
                        reject(e);
                    });
    ...
    SubmissionService.prototype.createSubmission = function (submission, formId) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.storage.get("ht_token").then(function (token) {
                if (token) {
                    _this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl + "/submissions?token=" + token, { fields: submission, form_id: formId }).subscribe(function (res) {
                        resolve(res);
                    }, function (e) {
                        reject(e);
                    });
...
var environment = {
    production: false,
    //apiUrl:"http://websites.localhost/htkinglogging/api/public/api"
    apiUrl: "http://128.199.192.224/api/public/api"
};
/*
...
module.exports = __webpack_require__(/*! D:\Taylor\Documents\Websites\htkinglogging\app\src\main.ts */"./src/main.ts");
