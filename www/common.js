...
var FormService = /** @class */ (function () {
    function FormService(http, storage) {
        this.http = http;
        this.storage = storage;
    }
    FormService.prototype.getForms = function (search, filters) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.storage.get("ht_token").then(function (token) {
                if (token) {
                    _this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl + "/forms?token=" + token + "&search=" + search + "&city=" + filters.city + "&orderby=" + filters.orderby + "&order=" + filters.order).subscribe(function (res) {
                        resolve(res);
                    }, function (e) {
                        reject(e);
                    });
    ...
    FormService.prototype.getFormGroups = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.storage.get("ht_token").then(function (token) {
                if (token) {
                    _this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl + "/formgroups?token=" + token).subscribe(function (res) {
                        resolve(res);
                    }, function (e) {
                        reject(e);
                    });
    ...
    FormService.prototype.getForm = function (formId) {
        ...
        return new Promise(function (resolve, reject) {
            _this.storage.get("ht_token").then(function (token) {
                if (token) {
                    _this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl + "/forms/" + formId + "?token=" + token).subscribe(function (res) {
                        resolve(res);
                    }, function (e) {
                        reject(e);
                    });
